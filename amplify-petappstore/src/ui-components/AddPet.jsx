...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeOneSixZeroTwoSixSevenFiveValue,
    setTextFieldThreeOneSixZeroTwoSixSevenFiveValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneSixZeroTwoSixEightTwoValue,
    setTextFieldThreeOneSixZeroTwoSixEightTwoValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneSixZeroTwoSixEightNineValue,
    setTextFieldThreeOneSixZeroTwoSixEightNineValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeOneSixZeroTwoSixSevenFiveValue,
      image: textFieldThreeOneSixZeroTwoSixEightTwoValue,
      color: textFieldThreeOneSixZeroTwoSixEightNineValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonThreeOneSixZeroTwoSevenZeroSixOnClick = useDataStoreUpdateAction({
    fields: {
      name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
      age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      breed: textFieldTwoNineSevenSixSixNineTwoFourValue,
      about: textFieldThreeOneSixZeroTwoSixSevenFiveValue,
      image: textFieldThreeOneSixZeroTwoSixEightNineValue,
      color: textFieldThreeOneSixZeroTwoSixEightTwoValue,
    },
    id: pet?.id,
    model: Pet,
    schema: schema,
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneSixZeroTwoSixSevenFiveValue}
            onChange={(event) => {
              setTextFieldThreeOneSixZeroTwoSixSevenFiveValue(
                event.target.value
              );
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneSixZeroTwoSixEightTwoValue}
            onChange={(event) => {
              setTextFieldThreeOneSixZeroTwoSixEightTwoValue(
                event.target.value
              );
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneSixZeroTwoSixEightNineValue}
            onChange={(event) => {
              setTextFieldThreeOneSixZeroTwoSixEightNineValue(
                event.target.value
              );
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeOneSixZeroTwoSevenZeroSixOnClick();
            }}
            {...getOverrideProps(overrides, "Button31602706")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
